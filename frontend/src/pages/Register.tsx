...
import { KeyRound, Mail, UserPlus, User, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="glass w-full max-w-md p-8 rounded-3xl shadow-2xl flex flex-col gap-6 relative z-10 animate-slide-up">
        ...
        <div className="flex flex-col items-center text-center gap-2">
          <div className="bg-gradient-to-tr from-indigo-500 to-violet-600 p-3 rounded-2xl shadow-lg shadow-indigo-500/15">
          ...
          <p className="text-sm text-slate-400">
            Bergabunglah untuk mulai mengatur tugas Anda dengan cerdas.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          {(error || localError) && (
            <div className="text-xs font-semibold text-rose-400 bg-rose-500/10 border border-rose-500/20 px-3.5 py-2.5 rounded-xl animate-fade-in">
              {localError || error}
            </div>
          )}
